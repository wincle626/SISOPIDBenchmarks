...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        float X1 = (float) inputs[2][0];
        float X2 = (float) inputs[3][0];
        float X3 = (float) inputs[4][0];
        float X4 = (float) inputs[5][0];
        float X5 = (float) inputs[6][0];
        float X6 = (float) inputs[7][0];
        float X7 = (float) inputs[8][0];
        float X8 = (float) inputs[9][0];
        float X = (float) inputs[10][0];
        float E = (float) inputs[11][0];
        float P = (float) inputs[12][0];
        float I = (float) inputs[13][0];
        float D = (float) inputs[14][0];
        float PID = (float) inputs[15][0];
        float Kp = (float) inputs[16][0];
        float Ki = (float) inputs[17][0];
        float Kd = (float) inputs[18][0];
        RightHalfPlaneZero_SISO<float>(setpoint, dt, X1, X2, X3, X4,

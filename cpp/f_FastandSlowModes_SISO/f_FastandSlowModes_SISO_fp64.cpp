...
#include "f_FastandSlowModes_SISO.h"
...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        double X = (double) inputs[2][0];
        double X1 = (double) inputs[3][0];
        double X2 = (double) inputs[4][0];
        double X3 = (double) inputs[5][0];
        double X4 = (double) inputs[6][0];
        double E = (double) inputs[7][0];
        double P = (double) inputs[8][0];
        double I = (double) inputs[9][0];
        double D = (double) inputs[10][0];
        double PID = (double) inputs[11][0];
        double Kp = (double) inputs[12][0];
        double Ki = (double) inputs[13][0];
        double Kd = (double) inputs[14][0];
        FastandSlowModes_SISO<double>(setpoint, dt, X, X1, X2, X3, X4,
        ...
        outputs[5] = factory.createScalar(X);
        outputs[6] = factory.createScalar(X1);
        outputs[7] = factory.createScalar(X2);
        outputs[8] = factory.createScalar(X3);
        outputs[9] = factory.createScalar(X4);
    }

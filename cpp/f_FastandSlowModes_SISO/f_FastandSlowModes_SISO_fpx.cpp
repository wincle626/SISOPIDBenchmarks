...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        FPX_T X = (FPX_T) inputs[2][0];
        FPX_T X1 = (FPX_T) inputs[3][0];
        FPX_T X2 = (FPX_T) inputs[4][0];
        FPX_T X3 = (FPX_T) inputs[5][0];
        FPX_T X4 = (FPX_T) inputs[6][0];
        FPX_T E = (FPX_T) inputs[7][0];
        FPX_T P = (FPX_T) inputs[8][0];
        FPX_T I = (FPX_T) inputs[9][0];
        FPX_T D = (FPX_T) inputs[10][0];
        FPX_T PID = (FPX_T) inputs[11][0];
        FPX_T Kp = (FPX_T) inputs[12][0];
        FPX_T Ki = (FPX_T) inputs[13][0];
        FPX_T Kd = (FPX_T) inputs[14][0];
        FastandSlowModes_SISO<FPX_T>(setpoint, dt, X, X1, X2, X3, X4,
        ...
        outputs[7] = factory.createScalar((double)X2);
        outputs[8] = factory.createScalar((double)X3);
        outputs[9] = factory.createScalar((double)X4);
    }

...
#include "h_UnstablePole_SISO.h"
#include "./fpx/floatx.hpp"
#define EXPONENT (unsigned int)7
#define SIGNIFICAND (unsigned int)15
...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        FPX_T E = (FPX_T) inputs[4][0];
        FPX_T P = (FPX_T) inputs[5][0];
        FPX_T I = (FPX_T) inputs[6][0];
        FPX_T D = (FPX_T) inputs[7][0];
        FPX_T PID = (FPX_T) inputs[8][0];
        FPX_T Kp = (FPX_T) inputs[9][0];
        FPX_T Ki = (FPX_T) inputs[10][0];
        FPX_T Kd = (FPX_T) inputs[11][0];
        UnstablePole_SISO<FPX_T>(setpoint, dt, X1, X2,

...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        double X = (double) inputs[5][0];
        double E = (double) inputs[6][0];
        double P = (double) inputs[7][0];
        double I = (double) inputs[8][0];
        double D = (double) inputs[9][0];
        double PID = (double) inputs[10][0];
        double Kp = (double) inputs[11][0];
        double Ki = (double) inputs[12][0];
        double Kd = (double) inputs[13][0];
        TimeDelayandLag_SISO<double>(setpoint, dt, Y, X1, X2, X, 
        ...
        outputs[8] = factory.createScalar(X);
    }

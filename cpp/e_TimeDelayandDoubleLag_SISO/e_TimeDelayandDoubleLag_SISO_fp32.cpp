...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        float X = (float) inputs[5][0];
        float E = (float) inputs[6][0];
        float P = (float) inputs[7][0];
        float I = (float) inputs[8][0];
        float D = (float) inputs[9][0];
        float PID = (float) inputs[10][0];
        float Kp = (float) inputs[11][0];
        float Ki = (float) inputs[12][0];
        float Kd = (float) inputs[13][0];
        TimeDelayandLag_SISO<float>(setpoint, dt, Y, X1, X2, X, 

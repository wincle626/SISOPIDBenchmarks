...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        double E = (double) inputs[4][0];
        double P = (double) inputs[5][0];
        double I = (double) inputs[6][0];
        double D = (double) inputs[7][0];
        double PID = (double) inputs[8][0];
        double Kp = (double) inputs[9][0];
        double Ki = (double) inputs[10][0];
        double Kd = (double) inputs[11][0];
        SecondOrderSystem_SISO<double>(setpoint, dt, X1, X2,

...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        FPX_T E = (FPX_T) inputs[3][0];
        FPX_T P = (FPX_T) inputs[4][0];
        FPX_T I = (FPX_T) inputs[5][0];
        FPX_T D = (FPX_T) inputs[6][0];
        FPX_T PID = (FPX_T) inputs[7][0];
        FPX_T Kp = (FPX_T) inputs[8][0];
        FPX_T Ki = (FPX_T) inputs[9][0];
        FPX_T Kd = (FPX_T) inputs[10][0];
        MultipleEqualPoles_SISO<FPX_T>(setpoint, dt, X,
             E, P, I, D, PID, 
             Kp, Ki, Kd);

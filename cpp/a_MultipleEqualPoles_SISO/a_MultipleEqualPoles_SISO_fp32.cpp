...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        float E = (float) inputs[3][0];
        float P = (float) inputs[4][0];
        float I = (float) inputs[5][0];
        float D = (float) inputs[6][0];
        float PID = (float) inputs[7][0];
        float Kp = (float) inputs[8][0];
        float Ki = (float) inputs[9][0];
        float Kd = (float) inputs[10][0];
        MultipleEqualPoles_SISO<float>(setpoint, dt, X,
             E, P, I, D, PID, 
             Kp, Ki, Kd);
